...
\PY{n}{laguerre\PYZus{}polymonials}\PY{p}{(}
    \PY{n}{t}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,}
    \PY{n}{n}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,}
    \PY{n}{beta}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,}
...
\PY{n}{laguerre\PYZus{}polynomials\PYZus{}tabulation}\PY{p}{(}
    \PY{n}{n}\PY{o}{=}\PY{l+m+mi}{20}\PY{p}{,}
    \PY{n}{t\PYZus{}max}\PY{o}{=}\PY{l+m+mi}{5}
\PY{p}{)}
	\end{Verbatim}
\end{tcolorbox}
...
\PY{n}{laguerre\PYZus{}transform}\PY{p}{(}
    \PY{n}{f}\PY{o}{=}\PY{k}{lambda} \PY{n}{t}\PY{p}{:} \PY{n}{np}\PY{o}{.}\PY{n}{exp}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{n}{t} \PY{o}{*}\PY{o}{*} \PY{l+m+mi}{2}\PY{p}{)}\PY{p}{,}
...
\PY{n}{laguerre\PYZus{}polynomials\PYZus{}plot}\PY{p}{(}
    \PY{n}{t\PYZus{}max}\PY{o}{=}\PY{l+m+mi}{4}\PY{p}{,}
    \PY{n}{n\PYZus{}max}\PY{o}{=}\PY{l+m+mi}{20}\PY{p}{,}
\PY{p}{)}
	\end{Verbatim}
\end{tcolorbox}
...
\begin{center}
	\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{plots/polynomials.png}
\end{center}
{ \hspace*{\fill} \\}
...
\PY{p}{)}
	...
	\begin{center}
		\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{plots/function.png}
	\end{center}
	{ \hspace*{\fill} \\}
...
\PY{n}{laguerre\PYZus{}transform\PYZus{}plot}\PY{p}{(}
    \PY{n}{f}\PY{o}{=}\PY{n}{g}\PY{p}{,}
    \PY{n}{n\PYZus{}max}\PY{o}{=}\PY{l+m+mi}{20}\PY{p}{,}
    \PY{n}{int\PYZus{}points}\PY{o}{=}\PY{l+m+mi}{10000}\PY{p}{,}
    \PY{n}{t\PYZus{}max}\PY{o}{=}\PY{l+m+mi}{1}
\PY{p}{)}
			\end{Verbatim}
		\end{tcolorbox}
		
		\begin{center}
			\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{plots/custom_function.png}
		\end{center}
		{ \hspace*{\fill} \\}
